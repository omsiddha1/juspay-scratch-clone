...
const MidArea = () => {
  ...
  return (
    <div className="flex-1 h-full overflow-auto bg-gray-100 p-6" onDrop={handleDrop} onDragOver={handleDragOver}>
     <div className="rounded-lg shadow-md p-6" style={{ backgroundColor: 'rgb(243, 206, 206)' }}>


        {selectedSprite ? (
          <>
            <div className='flex gap-4'>
            <h2 className="text-2xl flex font-bold text-red-600 mb-4">Actions for Selected Sprite</h2>
              <div className='text-sm'><SpriteImage spriteName={selectedSprite.name} styles={{ width: "50px", height: "50px" }} /></div>
            </div>
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-red-600 mb-2">Current Actions:</h3>
